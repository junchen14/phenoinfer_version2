...
tp="union"
print(tp)
train_data="../data/vae/"+tp+"_train.txt"
train_group_data="../data/vae/"+tp+"_train_group.txt"


with open("../data/vae/non_trained_gene.pkl","rb") as f:
    non_train_gene=pkl.load(f)

with open("../data/vae/"+tp+"test.txt","rb") as f:
...
opamodel=gensim.models.Word2Vec.load("../opamodel/"+tp+"_association_only.model")
...
def run(objective):
    ...
    pkl.dump(bst,open("xgboost_vae_neutral_predict.model.pt","wb"))
    # predict
...
def predict(model, test_disease):
    ...
    print("non_train gene rank",np.mean(non_train_gene_rank))
    ...
    print(top_k(non_train_gene_rank, 10))
    print(top_k(non_train_gene_rank, 30))
    print(top_k(non_train_gene_rank, 50))
    print(top_k(non_train_gene_rank, 100))
    print(top_k(non_train_gene_rank, 500))
