...
print(tp)
train_data="../data/boost_bidirectional_sampling_part_gene/"+tp+"_train.txt"
train_group_data="../data/boost_bidirectional_sampling_part_gene/"+tp+"_train_group.txt"
...
with open("../data/boost_bidirectional_sampling_part_gene/"+tp+"test.txt","rb") as f:
    disease_gene_dic=pkl.load(f)

with open("../data/boost_bidirectional_sampling_part_gene/"+"non_train_disease.pkl","rb") as f:
...
def run(objective):
    ...
    pkl.dump(bst,open("xgboost_bidirectional_sampling_part_gene.model.pt","wb"))
    # predict
...
def predict(model, test_disease):
    ...
    for disease in test_disease:
        ...
        dtest = xgb.DMatrix("part_performance/test.txt")
        dtest_group = load_group_file("part_performance/test_group.txt")
    ...
    print("the average rank for non_train_gene",str(np.mean(non_train_gene_rank)))
...
def write_file(disease,test_disease):
    test_data = open("part_performance/test.txt", "w")
    test_group = open("part_performance/test_group.txt", "w")
    disease_vec = opamodel[disease]
    genes = test_disease[disease]
