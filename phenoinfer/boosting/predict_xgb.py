...
print(tp)
train_data="../data/boost_traindata_only/"+tp+"_train.txt"
train_group_data="../data/boost_traindata_only/"+tp+"_train_group.txt"

# test_data="../data/boost_data/"+tp+"_test.txt"
# test_group_data="../data/boost_data/"+tp+"_test_group.txt"

with open("../data/boost_traindata_only/"+tp+"test.txt","rb") as f:
...
def run(objective):
    ...
    pkl.dump(bst,open("xgboost.model.pt","wb"))
    # predict
...
def predict(model, test_disease):
    ...
    with open("performance/result_100.pkl","wb") as f:
        pkl.dump(average_rank,f)
    return final_result
